...
class Generator:
    ...
    def load_domains(self) -> None:
        with open("Monthly digest/domainFilter.json", "r", encoding="utf-8") as f:
                data = json.load(f)
        domains: set[str] = set()
            ...
            <html lang="en">
                <head>
                    ...
                    <style>
                        ...
                        background-color: #000000; /* page background outside the report */
                        }}
...
def main():
    topic = "AI and its impact on operations"
    generator = Generator()
